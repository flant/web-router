...
type GlobalConfigType struct {
    ...
    DefaultChannelForDefaultGroup string `default:"stable" split_words:"true"`
...
func getVersionFromGroup(releases *ReleasesStatusType, group string) (version string, err error) {
    if  GlobalConfig.DefaultGroup == group  {
        return fmt.Sprintf("%s", GlobalConfig.DefaultChannelForDefaultGroup), nil
    }
